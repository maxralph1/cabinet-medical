        ...
        <Layout>
            <div className="d-flex justify-content-between align-items-center">
                <h2 className="fs-3">
                    ...
                    <span>Add Inventory Product</span>
                </h2>
            </div>
                    ...
                    { (productUnits?.length > 0) && (
                        <section className="added-product-units">
                            ...
                            <ul className="list-unstyled">
                                { productUnits?.reverse()?.map((unit, index) => {
                                    return (
                                        <li key={ index }>
                                            <span>{ index+1 }:&nbsp;</span>
                                            <span>Product Number:&nbsp;<span className="fw-semibold">{ unit?.product_number }</span></span>,&nbsp;
                                            <span>Amount Purchased:&nbsp;<span className="fw-semibold">{ unit?.amount_purchased }</span></span>,&nbsp;
                                            <span>Manufacture Date:&nbsp;<span className="fw-semibold">{ unit?.manufacture_date }</span></span>,&nbsp;
                                            <span>Expiration Date:&nbsp;<span className="fw-semibold">{ unit?.expiration_date }</span></span>
                                        </li>
                                    )
                                })}
                            </ul>
