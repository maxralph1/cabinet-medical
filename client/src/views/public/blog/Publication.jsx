...
export default function Publication() {
    ...
    const { id } = useParams(); 
    const { blogPublication, getBlogPublication, updateBlogPublication } = useBlogPublication(id); 
                        ...
                        <div className="d-flex gap-1">
                            <span 
                                ...
                                style={{ marginTop: '0.1rem' }}>
                                    {(blogPublication?.data?.likes?.length > 0) && blogPublication?.data?.likes?.find(foundLike => foundLike?.user?._id == user?.user?.user_id)
                                        ? 
                                        <button 
                                            onClick={ async () => {
                                                await deleteBlogPublicationLike((blogPublication?.data?.likes?.length > 0) && blogPublication?.data?.likes?.find(foundLike => foundLike?.user?._id == user?.user?.user_id));
                                        ...
                                        <button 
                                            onClick={ async () => {
                                                await createBlogPublicationLike(blogPublication?.data?._id); 
                                                await getBlogPublication(id); 
                                            } }
                                            className="text-decoration-none text-secondary d-flex align-items-center border-0 bg-transparent px-0">
                            ...
                            <span 
                                ...
                                className="">
                                    { blogPublication?.data?.likes?.length }&nbsp;like{ (blogPublication?.data?.likes?.length > 1) ? 's' : '' }
                            </span>
                        </div>
                                ...
                                <div className="modal-content">
                                    ...
                                    <div className="modal-body pt-3">
                                        ...
                                        <div className="d-flex flex-column gap-3">
                                            { (blogPublication?.data?.likes?.length > 0) 
                                                ?   blogPublication?.data?.likes?.map((like, index) => {
                                                        return (
                    ...
                    <section className="comments">
                        <div className="d-flex gap-1">
                            <span 
                                ...
                                className="">
                                    { (blogPublication?.data?.comments?.length > 0) && blogPublication.comments?.find(foundComment => foundComment?.user?._id == user?.user?.user_id) 
                            ...
                            <span 
                                ...
                                className="">
                                    { blogPublication?.data?.comments?.length }&nbsp;comment{ (blogPublication?.data?.comments?.length > 1) ? 's' : '' }
                            </span>
                        </div>
                                            ...
                                            <div className="row">
                                                <div className="form-floating mb-3 col-12">
                                                    ...
                                                    <input 
                                                        ...
                                                        name="article" 
                                                        id="article" 
                                                        defaultValue={ blogPublication?.data?._id } 
                                                        hidden="hidden" />
                                                </div>
                                            </div>
                                            <div className="row">
                        ...
                        <section className="comments-and-users modal fade" id={`blogPublicationComment${blogPublication?._id}Modal`} tabIndex="-1" aria-labelledby={`blogPublicationComment${blogPublication?._id}ModalLabel`}>
                            <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                <div className="modal-content">
                                    ...
                                    <div className="modal-body pt-3">
                                        <div className="d-flex flex-column gap-3">
                                            { (blogPublication?.data?.comments?.length > 0) 
                                                ?   blogPublication?.data?.comments?.map((comment, index) => {
                                                        return (
