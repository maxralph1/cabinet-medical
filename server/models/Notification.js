...
const notificationSchema = new Schema({
        ...
        type: { 
            type: String, 
            required: true, 
            enum: ['appointment-new', 'appiontment-cancel', 'appointment-modified', 'chat-message', 'diagnosis-result', 'invoice-new', 'invoice-payment', 'medical-bill-new', 'medical-bill-payment', 'regimen'], 
        }, 
    }, 
    {
